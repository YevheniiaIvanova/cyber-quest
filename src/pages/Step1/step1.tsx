      ...
      <div className="step1_wrapper">
        <div className="content">
          <p className={`${nextInstruction && 'd-none'}`}>
            ...
            <span className="">"Код Останньої Свободи"</span>— програму, яка може зламати систему та
            повернути контроль людям. Але цей код розбитий на фрагменти й захований у глибинах
            кіберпростору. Тобі потрібно розгадати всі загадки, знайти необхідні артефакти та
            розшифрувати код, щоб отримати свою нагороду.
          </p>

          <div className={`${!nextInstruction && 'd-none'}`}>
            <p>
            ...
            <div>
              <h3>010001100111001001101001011001000110011101100101</h3>
              <button
                onClick={() => {
